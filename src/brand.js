...
function emptyState(){
  return {
    ...
    products:[],
    ideas:[],
    sellerProfile:{name:'', address:'', contact:'', bankName:'', branchName:'', accountType:'普通', accountNumber:'', accountHolder:''},
    invoiceDraft:null,
    invoices:[]
  };
}
...
function ensureShape(){
  ...
  state.sellerProfile = state.sellerProfile && typeof state.sellerProfile === 'object' ? state.sellerProfile : {name:'', address:'', contact:'', bankName:'', branchName:'', accountType:'普通', accountNumber:'', accountHolder:''};
      ...
      <div class="invoice-sheet" id="invoiceSheet">
        <div class="invoice-head">
          ...
          <div class="invoice-meta">
            <div><span>${escapeHtml(docType)}番号</span><strong>${escapeHtml(draft.number || '-')}</strong></div>
            <div><span>${isDeliveryNote ? '納品日' : '発行日'}</span><strong>${draft.date || '-'}</strong></div>
          </div>
        </div>
